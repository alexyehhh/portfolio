document.addEventListener('DOMContentLoaded', () => {
    ...
    navLinkItems.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // Force nav into its scrolled (compact) state height for calculation
            const scrolledNavHeight = 56; // matches compact nav: ~1rem padding + logo height
            const targetPosition = targetSection.getBoundingClientRect().top + window.scrollY - scrolledNavHeight;
